...
?>
                        <form method="post" action="action.php">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>Medicine Name</td>
                                    <td><input type="text" class="form-control" value="<?php echo $row["m_name"]; ?>"
                                            name="name" placeholder="Enter Medicine name"></td>
                                </tr>
                                <tr>
                                    <td>Quantity</td>
                                    <td><input type="text" class="form-control" name="qty"
                                            value="<?php echo $row["qty"]; ?>" placeholder="Enter Quantity"></td>
                                </tr>
                                <tr>
...
?>
                        <form method="post" action="action.php">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>Quantity</td>
                                    <td><input type="text" class="form-control" name="qty" placeholder="Enter Quantity">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center"><input type="submit" class="btn btn-primary"
...
?>
                    <tr>
                        ...
                        <td><a href="action.php?delete=1&id=<?php echo $row["id"]; ?>" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
